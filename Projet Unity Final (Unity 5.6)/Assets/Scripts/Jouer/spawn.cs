		...
		if (temps > compteurFusee){
			...
			if (randomNumber == -(1+compare)%4-1){
				if (random == 0){
					...
					Instantiate(FuséeRouge,new Vector3(15.5f,-1f,randomNumber-5f),Quaternion.identity);
				}				
			}
				...
				if (random == 0){
					...
					Instantiate(FuséeBleue,new Vector3(15.5f,-1f,randomNumber-5f),Quaternion.identity);
				}				
			}
				...
				if (random == 0){
					...
					Instantiate(FuséeVerte,new Vector3(15.5f,-1f,randomNumber-5f),Quaternion.identity);
				}				
			}
				...
				if (random == 0){
					...
					Instantiate(FuséeJaune,new Vector3(15.5f,-1f,randomNumber-5f),Quaternion.identity);
				}				
			}
